...
ALTER TABLE public.game_chunk ADD CONSTRAINT game_chunk_owner_fkey FOREIGN KEY ("owner")
...
ALTER TABLE public.user_skills ADD CONSTRAINT user_skills_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skill(id);
ALTER TABLE public.user_skills ADD CONSTRAINT user_skills_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.game_user(id);
...
ALTER TABLE public.user_friends ADD CONSTRAINT user_friends_friend_id_fkey FOREIGN KEY (friend_id) REFERENCES public.game_user(id);
ALTER TABLE public.user_friends ADD CONSTRAINT user_friends_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.game_user(id);
