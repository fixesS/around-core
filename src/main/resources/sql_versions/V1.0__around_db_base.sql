...
(
    ...
    name varchar(30) DEFAULT 'Раунд'::character varying,
    starts timestamp NOT NULL,
    ends timestamp NOT NULL,
    active boolean not null DEFAULT false,
    CONSTRAINT round_pkey PRIMARY KEY (id)
);
CREATE UNIQUE INDEX only_one_true_for_round ON public.round (active) WHERE (active);
...
CREATE TABLE public.user_round_team(
    user_id int8 NOT NULL,
    round_id int8 NOT NULL,
    team_id int8 NOT NULL,
    CONSTRAINT user_round_team_pk PRIMARY KEY (user_id,round_id),
    UNIQUE (user_id,round_id)
);
ALTER TABLE public.user_round_team ADD CONSTRAINT user_round_team_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.team(id);
ALTER TABLE public.user_round_team ADD CONSTRAINT user_round_team_round_id_fkey FOREIGN KEY (round_id) REFERENCES public.round(id);
ALTER TABLE public.user_round_team ADD CONSTRAINT user_round_team_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.game_user(id);
...
(
    ...
    round_id int8 not null,
    "owner" int8    NULL,
    CONSTRAINT game_chunk_pk PRIMARY KEY (id, round_id),
    UNIQUE (id,round_id)
);
ALTER TABLE public.game_chunk ADD CONSTRAINT game_chunk_owner_fkey FOREIGN KEY (owner) REFERENCES public.game_user (id);
ALTER TABLE public.game_chunk ADD CONSTRAINT game_chunk_round_fkey FOREIGN KEY (round_id) REFERENCES public.round (id);
...
ALTER TABLE public.map_events_game_chunk ADD CONSTRAINT map_events_game_chunk_chunk_fk FOREIGN KEY (chunk_id,round_id) REFERENCES public.game_chunk(id,round_id);
