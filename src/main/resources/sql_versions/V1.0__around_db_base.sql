...
(
    ...
    CONSTRAINT chunks_owner_fkey FOREIGN KEY (owner) REFERENCES public.users_rounds_team_city(user_id),
    CONSTRAINT chunks_round_fkey FOREIGN KEY (round_id) REFERENCES public.users_rounds_team_city(round_id),
    CONSTRAINT chunks_city_fkey FOREIGN KEY (city_id) REFERENCES public.users_rounds_team_city(city_id)
);
