...
(
    ...
    CONSTRAINT chunks_owner_fkey FOREIGN KEY (owner) REFERENCES public.users (id),
    CONSTRAINT chunks_round_fkey FOREIGN KEY (round_id) REFERENCES public.rounds (id),
    CONSTRAINT chunks_city_fkey FOREIGN KEY (city_id) REFERENCES public.cities (id)
);
...
CREATE TABLE public.skills(
    ...
    CONSTRAINT skill_fk FOREIGN KEY (rule_id) REFERENCES public.rules(id),
    CONSTRAINT skill_fk_1 FOREIGN KEY (cost_id) REFERENCES public.costs (id)
);
...
CREATE TABLE public.map_events_categories (
    ...
    CONSTRAINT map_events_category_event_fk FOREIGN KEY (event_id) REFERENCES public.map_events(id),
    CONSTRAINT map_events_category_category_fk FOREIGN KEY (category_id) REFERENCES public.event_categories(id)
);
CREATE TABLE public.map_events_chunks(
    ...
    CONSTRAINT map_events_game_chunk_event_fk FOREIGN KEY (event_id) REFERENCES public.map_events(id),
...
CREATE TABLE public.map_events_users (
    ...
    CONSTRAINT map_events_game_user_event_fk FOREIGN KEY (event_id) REFERENCES public.map_events(id),
