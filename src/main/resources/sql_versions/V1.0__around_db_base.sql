...
CREATE TABLE settings.game(
    id int8 not null,
    user_chunk_reward int4 not null default 1,
    user_level_exp_cost_rule json not null,
    user_level_max int4 not null default 10000,
    team_change_cost int4 not null default 100,
    team_win_reward_coins int4 not null default 500,
    team_win_reward_exp int4 not null default 100,
    team_win_reward_coins_dividing_ratio float4 not null default 0.5,
    team_win_reward_exp_dividing_ratio float4 not null default 0.5,
...
CREATE TABLE public.rounds(
    ...
    previous_round_id int8 null,
    next_round_id int8 null,
    CONSTRAINT rounds_pkey PRIMARY KEY (id),
    CONSTRAINT rounds_previous_fkey foreign key (previous_round_id) references public.rounds(id),
    CONSTRAINT rounds_next_fkey foreign key (next_round_id) references public.rounds(id),
...
CREATE TABLE public.users(
    ...
    experience int8 NOT NULL DEFAULT 0,
