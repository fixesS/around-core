...
CREATE TABLE public.users_rounds_team
(
...
ALTER TABLE public.users_rounds_team ADD CONSTRAINT urt_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams (id);
ALTER TABLE public.users_rounds_team ADD CONSTRAINT urt_round_id_fkey FOREIGN KEY (round_id) REFERENCES public.rounds (id);
ALTER TABLE public.users_rounds_team ADD CONSTRAINT urt_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users (id);
...
ALTER TABLE public.map_events_chunks ADD CONSTRAINT map_events_game_chunk_chunk_fk FOREIGN KEY (chunk_id,round_id) REFERENCES public.chunks (id,round_id);
