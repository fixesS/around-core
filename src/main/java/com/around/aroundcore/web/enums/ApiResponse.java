...
public enum ApiResponse {
    ...
    USER_ALREADY_HAS_OAUTH_ACCOUNT(-2010,"You trying to connect oauth account, that already have been connected."),
    ...
    CHUNK_DOES_NOT_RELATES_WITH_USER_CITY(-6002,"Chunk you trying to own is not in your city."),
