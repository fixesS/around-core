...
public enum ApiResponse {
    ...
    CHUNK_DOES_NOT_CORRELATE_WITH_USER_CITY(-6002,"Chunk you trying to own is not in your cities."),
    CHUNK_DOES_NOT_CORRELATE_WITH_ANY_CITY(-6003,"Chunk you trying to own is not in any allowed cities."),
    ...
    ROUND_NAME_SIZE(-9003,"Round name must be more than 2 and less then 30.", HttpStatus.NOT_FOUND),
    ROUND_ID_FORMAT(-9004,"Round id cannot be less than 1.", HttpStatus.NOT_FOUND),
    ROUND_NAME_FORMAT(-9005,"Round name cannot be empty.", HttpStatus.NOT_FOUND),
    ROUND_SETTINGS_FORMAT(-9006,"Settings id cannot be less than 1.", HttpStatus.NOT_FOUND),
    ...
    CITY_DOES_NOT_EXIST(-12001,"City doest not exist.", HttpStatus.NOT_FOUND),
    GAME_SETTINGS_DOEST_NOT_EXIST(-13001,"Game setting does not exist.", HttpStatus.NOT_FOUND);
